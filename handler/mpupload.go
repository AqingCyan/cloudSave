...
func InitialMultipartUploadHandler(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		_, _ = w.Write(util.NewRespMsg(-1, "params invalid", nil).JSONBytes())
		return
	}
...
func UploadPartHandler(w http.ResponseWriter, r *http.Request) {
	...
	_ = os.MkdirAll(path.Dir(fpath), 0744)
...
func CompleteUploadHandler(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		_, _ = w.Write(util.NewRespMsg(-1, "complete upload failed", nil).JSONBytes())
		return
	}
	totalCount := 0
	chunkCount := 0
	...
	if totalCount != chunkCount {
		_, _ = w.Write(util.NewRespMsg(-2, "invalid request", nil).JSONBytes())
		return
	}
